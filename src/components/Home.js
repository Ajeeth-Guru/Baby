...
import './Home.css'
import img from'./images/background-01.png'
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        ...
        <p className='para'><i class="fa-solid fa-circle-check"></i>Profssionals only</p></div>
     
        <button className=' fw-bol' onClick={()=>{navigate('/product')}}>Learn more</button>
      </div>
    </div>
    <div class="carousel-item">
      <img src="https://themes.potenzaglobalsolutions.com/html/sitters/images/slider/home-01/02.jpg " class="d-block img-fluid w-100 transparent-image" alt="..."/>
      <div class="carousel-caption d-none d-md-block">
        <h1 className='para1'>We're <span className='para1 text-primary'>babysitting agency</span></h1>
        <p className='para'>Find the perfect Babysitter.Book online through our service.</p>
        <button className=' fw-bol' onClick={()=>{navigate('/product')}}>Learn more</button>
      </div>
    </div>
  </div>
...
<div>
      <div>
        <img src='https://themes.potenzaglobalsolutions.com/html/sitters/images/service/service-logo.png' className='my-5'></img>
      </div>
      <div>
        <h1 className='para3 mx-lg-5 mx-sm-0'>Explore different types of sitters who provide the services for your requirements.</h1>
      </div>
      </div>
      <div id="carouselExampleControls" class="carousel slide mx-lg-5 mx-sm-0" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="cards-wrapper">
      <div class="card">
        <img src="https://themes.potenzaglobalsolutions.com/html/sitters/images/service/05.jpg" class="card-img-top" alt="..."/>
        <div class="card-body">
          <h5 class="card-title">High school sitters</h5>
         
        </div>
      </div>
      <div class="card d-none d-md-block">
        <img src="https://themes.potenzaglobalsolutions.com/html/sitters/images/service/06.jpg" class="card-img-top" alt="..."/>
        <div class="card-body">
          <h5 class="card-title">Mother's helpers</h5>
        </div>
      </div>
      <div class="card d-none d-md-block">
        <img src="https://themes.potenzaglobalsolutions.com/html/sitters/images/service/07.jpg" class="card-img-top" alt="..."/>
        <div class="card-body">
          <h5 class="card-title">Trustworthy neighbors</h5>
    ...
    <div class="carousel-item">
      <div class="cards-wrapper">
        <div class="card">
          <img src="https://themes.potenzaglobalsolutions.com/html/sitters/images/service/12.jpg" class="card-img-top" alt="..."/>
          <div class="card-body">
...
<div className='row mx-lg-5 mt-lg-5 mt-sm-2 mx-sm-0'>
  <div className='col-lg-6 col-sm-12'>
    <img className='img-fluid h-100' src='https://themes.potenzaglobalsolutions.com/html/sitters/images/about/about-06.jpg'></img>
  </div>
  <div class="col-lg-6 col-sm-12">
            <div class="section-contant">
            <div class="section-title">
              <h1 class="mx-lg-3 mx-sm-0 my-5 font">We think your little ones justify the very best care.</h1>
              <h3 className='mx-lg-3 mx-sm-0 font'>Connect with sitter near you and find the one that’s right for your baby.</h3>
              <p className='list mx-lg-3 mx-sm-0 my-3 font'>Positive pleasure-oriented goals are much more powerful motivators than negative fear-based ones. Although each is successful separately, the right combination of both is the most powerful motivational force known to humankind.</p>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mt-3">
                <div class="author-signature">
                  <img class="img-fluid" src="https://themes.potenzaglobalsolutions.com/html/sitters/images/about/signature.jpg" alt=""/>
                </div>
              </div>
              <div class="col-md-6 mt-3">
                <h6 class="author-name font">Michael Jordan</h6>
...
<div className='box  mx-lg-5 mx-sm-0 mt-lg-5 my-sm-0 '>
  <h1>Are you looking for baby sitter just book!<span><img src='https://themes.potenzaglobalsolutions.com/html/sitters/images/action-box-arrow.png'></img><button className='btn btn-secondary' onClick={()=>{navigate('/product')}}>BOOK</button></span></h1>
</div>

<div>
<section class="pricing-section-title bg-overlay-black-60 bg-holder badg">
      <div class="container">
        <div class="row justify-content-center position-relative">
          <div class="col-lg-8 col-md-12">
            <div class="section-title text-center">
              <h1 class="text-white">Choose your best babysitter for your best baby.</h1>
            </div>
          </div>
        </div>
      </div>
    </section>
    <div class="content  mx-lg-5 mx-sm-0">
  <div class="benefits">
